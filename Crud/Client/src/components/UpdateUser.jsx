...
useEffect(()=>{
  axios.get(`https://mern-stack-crud-operations-hazel.vercel.app/getUser/${id}`)
...
const Updated =(e)=>{
  e.preventDefault()
  axios.put(`https://mern-stack-crud-operations-hazel.vercel.app/UpdateUser/${id}`,{name,email,age})
  .then(result=>{
    console.log(result)
    navigate('/')
  })
